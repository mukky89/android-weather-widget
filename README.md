...
- Pri viacerých udalostiach zobrazeného dňa sa názov, čas a odkaz na detail menia každých 8 sekúnd. Poradie ukazuje napríklad **1/3** pri názve kalendára. Cyklus zahŕňa celodenné aj už skončené udalosti z počítadla a začína najbližším stretnutím. Šípkami **‹ ›** pri názve kalendára možno prepínať ručne v oboch smeroch, vrátane prechodu medzi prvou a poslednou udalosťou. Posun sa týka iba daného kalendára a konkrétneho widgetu. Jediná udalosť zostáva statická a šípky sa skryjú. Obnova widgetu začne cyklus znovu.
